...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Method returning largest of two rectangle's area.
    ...
    def square(cls, size=0):
        """
        Method for building a square based on the Rectangle class

        Returns: A square object of height and width of "size"
        """
        square = Rectangle()
        square.height = size
        square.width = size
